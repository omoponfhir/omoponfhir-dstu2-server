...
<script>
var userReadCheckBoxIds = ["#user_condition_r", "#user_documentreference_r", "#user_encounter_r", "#user_medicationstatement_r", "#user_medicationorder_r", "#user_observation_r", "#user_patient_r", "#user_procedure_r"];
var userWriteCheckBoxIds = ["#user_condition_w", "#user_documentreference_w", "#user_encounter_w", "#user_medicationstatement_w", "#user_medicationorder_w", "#user_observation_w", "#user_patient_w", "#user_procedure_w"];
var patientReadCheckBoxIds = ["#patient_condition_r", "#patient_documentreference_r", "#patient_encounter_r", "#patient_medicationstatement_r", "#patient_medicationorder_r", "#patient_observation_r", "#patient_patient_r", "#patient_procedure_r"];
var patientWriteCheckBoxIds = ["#patient_condition_w", "#patient_documentreference_w", "#patient_encounter_w", "#patient_medicationstatement_w", "#patient_medicationorder_w", "#patient_observation_w", "#patient_patient_w", "#patient_procedure_w"];
var resources = ["Condition", "DocumentReference", "Encounter", "MedicationStatement", "MedicationOrder", "Observation", "Patient", "Procedure"];
...
function update_user_r () {
	...
	if ($("#user_medicationorder_r").is(":checked")) {
		$("#user_medicationorder_r").prop("checked", true); 
		scopes += " "+typeName+"/MedicationOrder.read";
	} else {
		$("#user_medicationorder_r").prop("checked", false); 
	}
...
function update_user_w (scopes) {
	...
	if ($("#user_medicationorder_w").is(":checked")) {
		$("#user_medicationorger_w").prop("checked", true); 
		scopes += " "+typeName+"/MedicationOrder.write";
	} else {
		$("#user_medicationorder_w").prop("checked", false); 
	}
...
function update_patient_r (scopes) {
	...
	if ($("#patient_medicationorder_r").is(":checked")) {
		$("#patient_medicationorder_r").prop("checked", true); 
		scopes += " patient/MedicationOrder.read";
	} else {
		$("#patient_medicationorder_r").prop("checked", false); 
	}
...
function update_patient_w (scopes) {
	...
	if ($("#patient_medicationorder_w").is(":checked")) {
		$("#patient_medicationorder_w").prop("checked", true); 
		scopes += " patient/MedicationOrder.write";
	} else {
		$("#patient_medicationorder_w").prop("checked", false); 
	}
	...
	<tr>
		<td valign="top">
			<table style="width: 100%; border: 1px solid grey; border-collapse: collapse;">
				...
				<tr>
					<td style="border: 1px solid grey; padding: 5px;">MedicationOrder</td>
					<td style="border: 1px solid grey; padding: 5px;">
						<label for="user_medicationorder_r">read
							<input <%if (disableIt) {out.print("disabled");} %> type="checkbox" id="user_medicationorder_r" name="user_medicationorder_r" > 
						</label>
 						<label for="user_medicationorder_w"> write
 							<input <%if (disableIt) {out.print("disabled");} %> type="checkbox" id="user_medicationorder_w" name="user_medicationorder_w" >
 						</label>
					</td>
				</tr>
				<tr>
	...
	<td valign="top" id="patient_scope_content">
		<table style="width: 100%; padding: 2px; border: 1px solid grey; border-collapse: collapse;">
			...
			<tr>
				<td style="border: 1px solid grey; padding: 5px;">MedicationOrder</td>
				<td style="border: 1px solid grey; padding: 5px;">
					<label for="patient_medicationorder_r">read
						<input <%if (disableIt) {out.print("disabled");} %> type="checkbox" id="patient_medicationorder_r" name="patient_medicationorder_r" >
					</label>
 					<label for="patient_medicationorder_w">write
 						<input <%if (disableIt) {out.print("disabled");} %> type="checkbox" id="patient_medicationorder_w" name="patient_medicationorder_w" >
 					</label>
				</td>
			</tr>
			<tr>
